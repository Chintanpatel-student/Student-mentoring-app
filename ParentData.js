...
export default class ParentData extends Component {
  ...
  componentDidMount() {
       ...
       return fetch('https://mentorstudent.000webhostapp.com/parentdata.php')
...
<View style={styles.MainContainer}>
       ...
       <FlatList
          ...
          renderItem={({item}) => <Text style={styles.FlatListItemStyle} 
                                        onPress={this.GetFlatListItem.bind(this, item.father_name)}>
                                    ID: {item.id} 
                                  </Text> }
